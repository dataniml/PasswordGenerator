...
randomChars = ctk.CTkEntry(root, placeholder_text="Enter two random chars", width=150)
passwordLabel = ctk.CTkLabel(root, text="Password: ", font=('Arial', 12))
generatedPass = ctk.CTkTextbox(root, width=200, height=10)
generateBtn = ctk.CTkButton(root, text="Generate", command = generate, width=90)
copyBtn = ctk.CTkButton(root, text="Copy", command = copy, width=50)
